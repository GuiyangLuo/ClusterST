...
def generate_graph_seq2seq_io_data(
        df, x_offsets, y_offsets, add_time_in_day= False, add_day_in_week = False
):
    """
    ...
    if add_time_in_day:
        ...
        time_ind = (df.index.values - df.index.values.astype("datetime64[D]")) / np.timedelta64(60 * 24, 'm')
    ...
    if add_day_in_week:
        ...
        print(" day_in_week ", day_in_week.shape)
