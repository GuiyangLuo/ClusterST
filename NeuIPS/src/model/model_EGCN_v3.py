...
class clustering_dynamic_learning_common_center_4(nn.Module):
    ...
    def forward(self, fushed_features, input_data):
        ...
        simi_mat = self.fast_cdist(fushed_features.view(self.batch_size*self.number_of_sensors, -1), self.centroids)
        ...
        return updated_input, cluster_difference_loss - cluster_kl
