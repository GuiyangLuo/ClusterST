...
def save_results(results,args):
    with open("dict_data_multiply_4.pkl", 'wb') as fo:
...
def train_main():
    ...
    args = SN(**config)
    args.device = 'cuda:{}'.format(GPUManager().auto_choice())
    ...
    name = cur_time + "neighbor{}_cluster{}_{}_{}".format(args.neighbors_for_each_nodes,args.gcn_n_class,args.centroid_way,args.simi_metric)
    # name = "12081556neighbor10_cluster5_cluster_2_euc"
